...
- **Despliegue en producción:** Ver [DEPLOYMENT.md](DEPLOYMENT.md) para build del JAR, variables de entorno y ejecución.
...
- [DEPLOYMENT.md](DEPLOYMENT.md) — Despliegue en producción (build, variables de entorno).
