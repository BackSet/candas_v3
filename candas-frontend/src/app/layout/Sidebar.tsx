...
export function Sidebar() {
  ...
  return (
    <div
      className={cn(
        'group relative z-50 flex h-full shrink-0 flex-col border-r border-sidebar-border bg-sidebar-background font-sans text-sidebar-foreground transition-[width] duration-200 ease-out',
    ...
    >
      ...
      >
        <div className="flex size-8 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary/80 text-xs font-bold text-primary-foreground shadow-sm">
          C
        </div>
        <div
          className={cn(
            'flex-1 overflow-hidden transition-[width,opacity] duration-200',
            sidebarCollapsed ? 'hidden w-0 opacity-0' : 'block w-auto opacity-100'
          )}
        >
      ...
      <div className="mb-1 px-2">
        <button
          ...
          className={cn(
            ...
            sidebarCollapsed ? 'mx-auto size-8 justify-center border-0 bg-transparent' : 'gap-2.5 px-3 py-1.5'
          )}
        >
                  ...
                  const linkContent = (
                    <Link
                      ...
                      className={cn(
                        ...
                        sidebarCollapsed ? 'mx-auto size-8 justify-center p-0' : 'gap-2.5 px-3 py-1.5'
                      )}
                      activeProps={{
                        className: cn(
                          ...
                          sidebarCollapsed ? 'mx-auto size-8 justify-center border-l-0 p-0' : 'gap-2.5 px-3 py-1.5'
                        ),
                      }}
      ...
      <div className="shrink-0 border-t border-border/50 p-2">
        <button
          ...
          className={cn(
            ...
            sidebarCollapsed ? 'mx-auto size-9 justify-center' : 'gap-2.5 px-3 py-2'
          )}
