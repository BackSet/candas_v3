...
import { Eye, Edit, Trash2, Plus, MapPin, MoreHorizontal, Loader2, AlertCircle } from 'lucide-react'
                  ...
                  <TableRow>
                    <TableCell colSpan={3} className="h-32 text-center">
                      <div className="flex flex-col items-center justify-center gap-2 text-muted-foreground">
                        ...
                        <span className="text-sm">Cargando puntos de origen...</span>
                      </div>
                    </TableCell>
                  </TableRow>
                ) : error ? (
                  <TableRow>
                    <TableCell colSpan={3} className="h-32 text-center text-destructive">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <span>Error al cargar puntos de origen</span>
                      </div>
                    </TableCell>
                  </TableRow>
